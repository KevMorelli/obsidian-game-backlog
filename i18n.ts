...
const esTranslations = {
		...
		toolbarExpandTitle: 'Mostrar herramientas',
		toolbarCollapseTitle: 'Ocultar herramientas',
		cardSizeLabel: 'Tamano',
		cardSizeTooltip: 'Ajustar el ancho de las tarjetas',
		noName: 'Sin nombre',
...
const enTranslations: TranslationDictionary = {
		...
		toolbarExpandTitle: 'Show tools',
		toolbarCollapseTitle: 'Hide tools',
		cardSizeLabel: 'Size',
		cardSizeTooltip: 'Adjust the card width',
		noName: 'Untitled',
		platformBrandAlt: 'Platform brand',
		platinumBadgeAlt: 'Platinum badge',
